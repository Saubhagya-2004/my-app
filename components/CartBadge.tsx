    ...
    return (
        <Link
            ...
            className="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 py-3.5
                       bg-green-600 text-white font-semibold text-sm rounded-2xl
                       shadow-[0_8px_24px_rgba(22,163,74,0.4)]
                       hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(22,163,74,0.5)]
                       transition-all duration-200 animate-slide-down"
        >
            <span className="relative">
                🛒
                <span className="absolute -top-2 -right-2.5 bg-white text-green-700 text-[10px] font-black
